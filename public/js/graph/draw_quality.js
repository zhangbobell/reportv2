...
//    $.ajax_draw("graph/get_chart_data", "report_monthly_order_close_rate", "#container12", '订单关闭比率', '订单关闭率（%）');
    ...
    $('#container9').drawLineChart({
        title: '总体上架率',
        subtitle: '副标题 for test',
        xLabel: '日期',
        yLabel: '总体上架率',
        columns: ['总体上架率']
    }, {
        url: 'graph/get_chart_data_m',
        saikufile: 'report_monthly_cooperation_up_rate'
    });

    $('#container12').drawLineChart({
        title: '订单关闭比率',
        subtitle: '副标题 for test',
        xLabel: '日期',
        yLabel: '订单关闭比率',
        ...
        url: 'graph/get_chart_data_m',
        saikufile: 'report_monthly_order_close_rate'
    });
