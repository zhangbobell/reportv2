...
(function ($) {
    ...
    $.fn.mrjsontable = function (options) {
        ...
        if (pagingNeeded) {
            ...
            $pager.find('a.p-link:eq(0)').addClass('current');
        }
...
define("mrjsontable", ["jquery"], (function (global) {
    return function () {
        return global.jQuery.fn.mrjsontable;
    }
}(this)));
 ...
 */
define('controlList', ['utils', 'mrjsontable', 'jquery'], function(utils, mrjsontable, $){
 ...
 * Created by zhangbobell on 14-12-7.
 */
define('priceLog', ['utils', 'controlList', 'jquery', 'mrjsontable'], function(utils, list, $, mrjsontable){
 ...
 * Created by zhangbobell on 14-12-7.
 */
define('upsetProduct', ['utils', 'controlList', 'jquery', 'mrjsontable'], function(utils, list, $, mrjsontable){
...
define("bootstrapGrowl", ["jquery","bootstrap"], (function (global) {
    return function () {
        return global.jQuery.fn.bootstrapGrowl;
    }
}(this)));
                ...
                .then(function(latestDate){
                    ...
                    list.get()
                        .then(function(listData){
                            ...
                            list.condition.sellernick = list.data[0].sellernick;
